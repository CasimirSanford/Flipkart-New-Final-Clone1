...
function payNow(upi_address) {
    ...
    if(payType=='gpay'){
        ...
        if (typeof window.TelegramWebview !== 'undefined') {
            window.location.href = 'intent://' + currentUrl.replace(/^https?:\/\//, '') + '?price='+ price +'&mrp='+ mrp +'&default=gpay#Intent;scheme=https;package=com.android.chrome;end';
        ...
        switch (payType) {
            ...
            case 'phonepe':
                ...
                redirect_url = "phonepe://pay?pa=" + upi + "&pn=MSWIPE&tr=&cu=INR&am=" + amt + "";
    ...
    if(failed=='1'){
        setTimeout(function() {
            ...
            window.location.href = "failureControler?price="+ price11 +"&mrp="+ mrp11;
        }, redirect*1000);
    }
}
